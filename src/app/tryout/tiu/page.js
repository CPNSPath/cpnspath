...
export default function TIUIntro() {
  ...
  return (
    <DashboardLayout>
      ...
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#0f172a", marginBottom: 4 }}>Free Trial TIU</h1>
      <p style={{ fontSize: "0.85rem", color: "#64748b", marginBottom: 24 }}>Tes Intelegensi Umum</p>
      ...
      <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: "24px", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {[
            { icon: "✅", text: "Pastikan koneksi internet stabil", ok: true },
            { icon: "✅", text: "Siapkan alat tulis untuk coret-coretan", ok: true },
            { icon: "✅", text: "Jawaban tersimpan otomatis", ok: true },
            { icon: "❌", text: "Jangan refresh atau tutup browser — jika dilakukan, ujian otomatis selesai dan dianggap submit", ok: false },
            { icon: "❌", text: "Ujian hanya dapat dikerjakan 1 kali", ok: false },
            { icon: "⏱", text: "Waktu akan berjalan otomatis setelah mulai", ok: null },
          ].map((item, i) => (
        ...
        <div style={{ marginTop: 16, padding: "10px 14px", background: "#f8fafc", borderRadius: 8, border: "1px solid #e2e8f0" }}>
          <p style={{ fontSize: "0.78rem", color: "#64748b" }}>
            <strong style={{ color: "#334155" }}>Bobot Nilai:</strong> Benar +5, salah/kosong 0. Passing grade: 80.
          </p>
        </div>
      </div>
      ...
      {alreadyDone ? (
        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: "24px", textAlign: "center" }}>
          ...
          <button onClick={() => router.push("/tryout/tiu/result")}
