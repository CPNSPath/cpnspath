            ...
            <div style={{ padding: "8px 24px 24px" }}>
              {alreadyDone && !toId ? (
                <div style={{ textAlign: "center" }}>
                  ...
                  <Link href="/tryout/twk/result" style={{ display: "block", width: "100%", padding: "13px 20px", borderRadius: 12, fontSize: "0.9rem", fontWeight: 600, textAlign: "center", textDecoration: "none", background: "#172554", color: "#fff" }}>
                    Lihat Hasil →
                  </Link>
                </div>
              ) : (
