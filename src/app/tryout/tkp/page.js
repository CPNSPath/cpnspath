...
export default function TKPIntro() {
  ...
  return (
    <DashboardLayout>
      ...
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#0f172a", marginBottom: 4 }}>Free Trial TKP</h1>
      <p style={{ fontSize: "0.85rem", color: "#64748b", marginBottom: 24 }}>Tes Karakteristik Pribadi</p>
      ...
      <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: "24px", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {[
            ...
            { icon: "✅", text: "Tidak ada jawaban benar atau salah — setiap opsi memiliki bobot nilai 1–5" },
        ...
        <div style={{ marginTop: 16, padding: "10px 14px", background: "#f8fafc", borderRadius: 8, border: "1px solid #e2e8f0" }}>
          <p style={{ fontSize: "0.78rem", color: "#64748b" }}>
            <strong style={{ color: "#334155" }}>Bobot Nilai:</strong> TKP setiap jawaban bernilai 1–5, kosong 0. Passing grade: 166.
          </p>
        </div>
      </div>
      ...
      {alreadyDone ? (
        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", padding: "24px", textAlign: "center" }}>
          ...
          <button onClick={() => router.push("/tryout/tkp/result")}
