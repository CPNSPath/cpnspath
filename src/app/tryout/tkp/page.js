      ...
      <section style={{ background: "#172554", padding: "56px 24px", position: "relative", overflow: "hidden", marginTop: "72px" }}>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "2rem", fontWeight: 700, color: "#fff", marginBottom: 8, letterSpacing: "-0.02em" }}>
            {toId ? `TO SKD #${toId} — TKP` : "Free Trial TKP"}
          </h1>
          <p style={{ fontSize: "0.95rem", color: "#93C5FD", lineHeight: 1.6 }}>Tes Karakteristik Pribadi</p>
        </div>
      </section>
        ...
        <div style={{ width: "100%", maxWidth: 420 }}>
          <div style={{ background: "#fff", borderRadius: 20, overflow: "hidden", border: "1px solid #e2e8f0", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
            <div style={{ background: "#0f1d3a", padding: "24px 20px 20px", textAlign: "center" }}>
              ...
              <h2 style={{ fontSize: "1.25rem", fontWeight: 700, color: "#fff" }}>TKP</h2>
              <p style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.6)", marginTop: 4 }}>Tes Karakteristik Pribadi</p>
            </div>
              ...
              {alreadyDone && !toId ? (
                <div style={{ textAlign: "center" }}>
                  <div style={{ background: "rgba(34,197,94,0.08)", border: "1px solid rgba(34,197,94,0.2)", borderRadius: 12, padding: "16px", marginBottom: 12 }}>
                    ...
                    <p style={{ fontSize: "0.8rem", color: "#64748b" }}>Kamu sudah menyelesaikan Free Trial TKP</p>
                  </div>
                  <Link href="/tryout/tkp/result" style={{ display: "block", width: "100%", padding: "13px 20px", borderRadius: 12, fontSize: "0.9rem", fontWeight: 600, textAlign: "center", textDecoration: "none", background: "#172554", color: "#fff" }}>
                    Lihat Hasil →
                  </Link>
                </div>
              ) : (
