    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-navy">Tes Karakteristik Pribadi (TKP)</h1>
        ...
        <div className="bg-white rounded-xl border shadow-sm mb-6">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex justify-between py-2"><span className="text-gray-600">Passing Grade</span><span className="font-semibold text-red-600">166</span></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border shadow-sm mb-8">
          ...
          <div className="p-6">
            <div className="flex items-start gap-3">
              <div className="w-1 h-8 rounded-full bg-green-500 mt-0.5"></div>
              <div>
                <span className="font-semibold text-green-600">Tes Karakteristik Pribadi (TKP)</span>
                <p className="text-sm text-gray-500">Passing grade minimal 166</p>
