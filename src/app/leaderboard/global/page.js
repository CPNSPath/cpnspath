  ...
  return (
    <DashboardLayout>
      ...
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: "1.75rem", fontWeight: 700, color: "#0f172a", marginBottom: 4, letterSpacing: "-0.02em" }}>🏆 Leaderboard Nasional</h1>
        <p style={{ fontSize: "0.9rem", color: "#64748b" }}>Ranking per Paket TO SKD</p>
      </div>

      {/* Card posisi kamu */}
      {currentUserId && myRank > 0 && (
        <div style={{ background: "linear-gradient(135deg, #172554, #1e3a5f)", borderRadius: 14, padding: "16px 20px", display: "inline-flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
